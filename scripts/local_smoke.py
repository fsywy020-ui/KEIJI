...
from keiji.manus_handoff import build_manus_handoff_packet, export_handoff_packets_csv, export_handoff_packets_json, export_handoff_packets_markdown
...
def main() -> int:
    ...
    try:
        ...
        for index, candidate in enumerate(candidates, start=1):
            ...
            p7_packets.append(review_packet)
            p8_handoff_packets.append(build_manus_handoff_packet(review_packet))
        ...
        export_handoff_packets_json(p8_handoff_packets, out_dir / "p8_manus_handoff_packets.json")
        export_handoff_packets_csv(p8_handoff_packets, out_dir / "p8_manus_handoff_packets.csv")
        export_handoff_packets_markdown(p8_handoff_packets, out_dir / "p8_manus_handoff_packets.md")
    finally:
        connection.close()
