...
def estimate_fees(expected_sale_price_yen: int, category: str, rules: dict[str, Any]) -> FeeBreakdown:
    ...
    return FeeBreakdown(
        ...
        fulfillment_fee_yen=int(amazon.get("default_fulfillment_fee_yen", 0)),
        storage_fee_yen=int(amazon.get("default_storage_fee_yen", 0)),
        other_cost_yen=int(amazon.get("default_other_cost_yen", 0)),
    )
