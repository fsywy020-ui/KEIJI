...
## P8 Manus Handoff Preparation

P8 adds **local handoff preparation** for a future human-controlled Manus workflow. It can turn a P7 human review packet into local P8 Manus handoff files:

- `p8_manus_handoff_packets.json`
- `p8_manus_handoff_packets.csv`
- `p8_manus_handoff_packets.md`

These files summarize the candidate, P4 identity result, P3 profit result, P5 market summary, P6 score, P7 review status, human checklist, budget impact, allowed Manus tasks, and forbidden operations.

P8 still does **not** let Manus operate a browser or external service. Manus must not log in, add items to a cart, check out, purchase, pay, list products, scrape websites, call live APIs, save authentication information, or perform any external operation without human approval.

Start with:

1. `docs/manus_handoff_policy.md`
2. `docs/manus_human_checklist.md`
3. `docs/blocked_actions_policy.md`
4. `storage/smoke/p8_manus_handoff_packets.md` after running the smoke workflow.
