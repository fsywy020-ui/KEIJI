...
If any non-KEIJI project artifact appears in code, config, docs, fixtures, environment variables, or tests, treat it as a project-boundary violation and remove it.
