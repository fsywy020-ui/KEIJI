...
Extracts conservative local attributes from manually provided titles and fixture text:
...
Extraction must prefer precision over recall and must not call external services. Missing extracted attributes should lead to review rather than unsafe acceptance.
